...
/*SF_DATA;ver:1.16;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,lico:1,lgpr:1,limd:0,spmd:1,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:False,hqlp:False,rprd:False,enco:False,rmgx:True,rpth:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,culm:2,bsrc:3,bdst:7,dpts:2,wrdp:False,dith:0,rfrpo:True,rfrpn:Refraction,ufog:False,aust:False,igpj:True,qofs:0,qpre:3,rntp:2,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,ofsf:0,ofsu:0,f2p0:True;n:type:ShaderForge.SFN_Final,id:3292,x:34529,y:33063,varname:node_3292,prsc:2|custl-2357-OUT,alpha-7979-OUT;n:type:ShaderForge.SFN_Tex2d,id:2275,x:33864,y:31786,ptovrint:False,ptlb:MainTex,ptin:_MainTex,varname:_MainTex,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:961d20a8e5427b541ba58f8a5c6a1356,ntxv:0,isnm:False|UVIN-4467-OUT;n:type:ShaderForge.SFN_Multiply,id:2357,x:33354,y:33273,varname:node_2357,prsc:2|A-2116-RGB,B-3036-OUT;n:type:ShaderForge.SFN_ScreenPos,id:2940,x:31938,y:33176,varname:node_2940,prsc:2,sctp:0;n:type:ShaderForge.SFN_Multiply,id:2675,x:32146,y:33297,varname:node_2675,prsc:2|A-2940-UVOUT,B-7561-OUT;n:type:ShaderForge.SFN_ValueProperty,id:7561,x:31938,y:33367,ptovrint:False,ptlb:DetailScale,ptin:_DetailScale,varname:_DetailScale,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,v1:1;n:type:ShaderForge.SFN_Panner,id:9135,x:32323,y:33232,varname:node_9135,prsc:2,spu:0.01,spv:-0.2|UVIN-2675-OUT;n:type:ShaderForge.SFN_Panner,id:3999,x:32323,y:33425,varname:node_3999,prsc:2,spu:-0.01,spv:-0.165|UVIN-2675-OUT;n:type:ShaderForge.SFN_Tex2d,id:5637,x:32698,y:33258,varname:_node_5637,prsc:2,ntxv:0,isnm:False|UVIN-9135-UVOUT,TEX-2091-TEX;n:type:ShaderForge.SFN_Tex2dAsset,id:2091,x:32360,y:33663,ptovrint:False,ptlb:DetailMap,ptin:_DetailMap,varname:_DetailMap,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Tex2d,id:450,x:32698,y:33453,varname:_node_9426,prsc:2,ntxv:0,isnm:False|UVIN-3999-UVOUT,TEX-2091-TEX;n:type:ShaderForge.SFN_Add,id:1609,x:32942,y:33453,varname:node_1609,prsc:2|A-5637-A,B-450-A;n:type:ShaderForge.SFN_Add,id:3036,x:33132,y:33404,varname:node_3036,prsc:2|A-5637-RGB,B-3320-OUT;n:type:ShaderForge.SFN_Color,id:2116,x:33132,y:33213,ptovrint:False,ptlb:FireColor,ptin:_FireColor,varname:_FireColor,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0.5,c2:0.5,c3:0.5,c4:1;n:type:ShaderForge.SFN_Multiply,id:3320,x:32943,y:33574,varname:node_3320,prsc:2|A-5637-A,B-450-A;n:type:ShaderForge.SFN_Multiply,id:7272,x:33793,y:32946,varname:node_7272,prsc:2|A-2275-A,B-8986-OUT;n:type:ShaderForge.SFN_Slider,id:8986,x:32605,y:32965,ptovrint:False,ptlb:ClipPower,ptin:_ClipPower,varname:_ClipPower,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:1,max:2;n:type:ShaderForge.SFN_Slider,id:2941,x:33331,y:33518,ptovrint:False,ptlb:Opacity,ptin:_Opacity,varname:_Opacity,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:1,max:1;n:type:ShaderForge.SFN_Multiply,id:7979,x:34074,y:33318,varname:node_7979,prsc:2|A-7272-OUT,B-2941-OUT,C-2889-OUT;n:type:ShaderForge.SFN_Time,id:5446,x:32033,y:32587,varname:node_5446,prsc:2;n:type:ShaderForge.SFN_Vector4Property,id:4595,x:32139,y:32033,ptovrint:False,ptlb:Sheet Params,ptin:_SheetParams,varname:_SheetParams,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,v1:1,v2:8,v3:8,v4:0;n:type:ShaderForge.SFN_Multiply,id:6710,x:32391,y:32177,varname:node_6710,prsc:2|A-4595-X,B-4595-Y;n:type:ShaderForge.SFN_Frac,id:2783,x:32592,y:32606,varname:node_2783,prsc:2|IN-173-OUT;n:type:ShaderForge.SFN_Fmod,id:1424,x:33151,y:32028,varname:node_1424,prsc:2|A-1585-OUT,B-4595-X;n:type:ShaderForge.SFN_Divide,id:7918,x:32248,y:32606,varname:node_7918,prsc:2|A-6710-OUT,B-4595-Z;n:type:ShaderForge.SFN_Floor,id:1585,x:32910,y:32552,varname:node_1585,prsc:2|IN-2813-OUT;n:type:ShaderForge.SFN_Append,id:7919,x:33593,y:32095,varname:node_7919,prsc:2|A-7817-OUT,B-3161-OUT;n:type:ShaderForge.SFN_Multiply,id:2813,x:32726,y:32552,varname:node_2813,prsc:2|A-6710-OUT,B-2783-OUT;n:type:ShaderForge.SFN_Divide,id:9672,x:32870,y:32252,varname:node_9672,prsc:2|A-1585-OUT,B-4595-X;n:type:ShaderForge.SFN_TexCoord,id:4558,x:33019,y:31651,varname:node_4558,prsc:2,uv:0;n:type:ShaderForge.SFN_Divide,id:7011,x:33254,y:31784,varname:node_7011,prsc:2|A-4558-UVOUT,B-4969-OUT;n:type:ShaderForge.SFN_Append,id:4969,x:33019,y:31831,varname:node_4969,prsc:2|A-4595-X,B-4595-Y;n:type:ShaderForge.SFN_Add,id:4467,x:33581,y:31786,varname:node_4467,prsc:2|A-7011-OUT,B-7919-OUT;n:type:ShaderForge.SFN_Divide,id:7817,x:33357,y:32028,varname:node_7817,prsc:2|A-1424-OUT,B-4595-X;n:type:ShaderForge.SFN_Floor,id:7734,x:33049,y:32252,varname:node_7734,prsc:2|IN-9672-OUT;n:type:ShaderForge.SFN_Divide,id:9322,x:33226,y:32252,varname:node_9322,prsc:2|A-7734-OUT,B-4595-Y;n:type:ShaderForge.SFN_OneMinus,id:3161,x:33400,y:32252,varname:node_3161,prsc:2|IN-9322-OUT;n:type:ShaderForge.SFN_Divide,id:173,x:32434,y:32562,varname:node_173,prsc:2|A-5446-T,B-7918-OUT;n:type:ShaderForge.SFN_Step,id:2889,x:33947,y:33591,varname:node_2889,prsc:2|A-9266-R,B-8822-OUT;n:type:ShaderForge.SFN_Tex2d,id:9266,x:33645,y:33648,ptovrint:False,ptlb:DissolveNoise,ptin:_DissolveNoise,varname:_DissolveNoise,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Slider,id:8822,x:33655,y:33895,ptovrint:False,ptlb:Dissolve,ptin:_Dissolve,varname:_Dissolve,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:1,max:1;proporder:2275-4595-2091-7561-2116-8986-2941-9266-8822;pass:END;sub:END;*/

Shader "Moba_C/2sss_Fire_Anim2" {
    Properties {
...
/////// Vectors:
////// Lighting:
                float4 node_476 = _Time + _TimeEditor;
                float2 node_2675 = (i.screenPos.rg*_DetailScale);
                float2 node_9135 = (node_2675+node_476.g*float2(0.01,-0.4));
                float4 _node_5637 = tex2D(_DetailMap,TRANSFORM_TEX(node_9135, _DetailMap));
                float2 node_3999 = (node_2675+node_476.g*float2(-0.01,-0.3));
                ...
                return fixed4(finalColor,((_MainTex_var.a*_ClipPower)*_Opacity*step(_DissolveNoise_var.r,_Dissolve)));
            }
            ENDCG
        }
    }
