...
Shader "E3DEffect/C3/Blast-3T-3C-Soft"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v )
		{
			...
			v.vertex.xyz += ( half4( ase_vertexNormal , 0.0 ) * _FireOffsetInstensity * lerp(( tex2DNode8 * 1.0 ),temp_output_52_0,_FireOffset) ).rgb;
		}
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			half4 temp_cast_4 = (( 1.0 - abs( i.uv_tex4coord.w ) )).xxxx;
			half4 temp_cast_5 = (5.0).xxxx;
			o.Alpha = saturate( pow( (float4( 0,0,0,0 ) + (saturate( ( ( 1.0 - tex2D( _DissloveMap, uv_DissloveMap ) ) + i.uv_tex4coord.w ) ) - float4( 0,0,0,0 )) * (float4( 1,1,1,0 ) - float4( 0,0,0,0 )) / (temp_cast_4 - float4( 0,0,0,0 ))) , temp_cast_5 ) ).r;
		}
...
/*ASEBEGIN
Version=16400
361;29;1552;1004;857.0635;-1015.769;1.3;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;34;-2373.397,729.5186;Float;False;Property;_UVTiling;UV-Tiling;11;0;Create;True;0;0;False;0;0;2;0;4;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;23;-1509.279,773.3278;Float;False;Property;_FireEdge;FireEdge;14;0;Create;True;0;0;False;0;0.468391;1.051;1;1.5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;8;-1642.44,118.0399;Float;True;Property;_SmokeTexture;SmokeTexture;12;0;Create;True;0;0;False;0;None;2d278e9219f95fd469f4ff3136fd7ff8;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;51;-681.1942,421.127;Float;False;Property;_AbroadColor;AbroadColor;7;1;[HDR];Create;True;0;0;False;0;2,0.6916838,0.1029413,1;2,0.3724138,0,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;47;-679.1132,55.16392;Float;False;Property;_SmokeColor;SmokeColor;6;0;Create;True;0;0;False;0;0.3183391,0.3949051,0.6764706,0;0.2573528,0.2038463,0.1797685,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;50;-684.5942,240.6183;Float;False;Property;_WithinColor;WithinColor;8;1;[HDR];Create;True;0;0;False;0;1.5,1.060289,0.6507353,1;1.5,0.9974733,0.5294117,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;54;431.618,1754.577;Float;False;Property;_FireOffsetInstensity;Fire-Offset-Instensity;15;0;Create;True;0;0;False;0;0.468391;6;0;6;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;106;-278.6481,1498.848;Float;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0.1;False;4;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;2391.677,871.5004;Half;False;True;6;Half;ASEMaterialInspector;0;0;Unlit;E3DEffect/C3/Blast-3T-3C-Soft;False;False;False;False;True;True;True;True;True;True;True;True;False;False;True;False;False;False;False;False;False;Off;2;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0.5;True;False;0;True;Overlay;;Transparent;All;True;True;True;True;True;True;False;False;False;False;False;False;False;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;True;2;2;10;25;False;0.5;False;2;5;False;-1;10;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;0;-1;-1;1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;106;0;42;4
WireConnection;0;2;48;0
WireConnection;0;9;112;0
WireConnection;0;11;32;0
ASEEND*/
//CHKSM=0CC4A1DE88BFD4D0330FA729581B7A87929FEC10