...
Shader "BH-effect/Additive Turbulence"
{
	Properties
	{
...
#include "UnityCG.cginc"
			...
			frag_data vert(vert_data IN) {
				...
				o.uv0.zw = TRANSFORM_TEX(IN.uv, _BlendTex);
				o.uv1.xy = TRANSFORM_TEX(IN.uv, _BlendTex01);
			...
			half4 frag(frag_data IN) : SV_TARGET
			{
				...
				half4 splatAlpha = IN.color.w;
				half4 multi4 = multi11 * splatAlpha;
